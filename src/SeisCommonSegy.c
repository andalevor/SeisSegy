...
{
    SeisCommonSegyPrivate* priv = (SeisCommonSegyPrivate*)malloc(sizeof(struct SeisCommonSegyPrivate));
    if (!priv)
        return NULL;
...
char const* seis_segy_default_text_header_rev0 = "C 1 CLIENT                        COMPANY                       CREW NO   "
                                                 "      "
...
char const* seis_segy_default_text_header_rev1 = "C 1 CLIENT                        COMPANY                       CREW NO   "
                                                 "      "
                                                 "C 2 LINE            AREA                        MAP ID                    "
                                                 "      "
                                                 "C 3 REEL NO           DAY-START OF REEL     YEAR      OBSERVER            "
...
char const* seis_segy_default_text_header_rev2 = "C 1 CLIENT                        COMPANY                       CREW NO   "
                                                 "      "
                                                 "C 2 LINE            AREA                        MAP ID                    "
                                                 "      "
                                                 "C 3 REEL NO           DAY-START OF REEL     YEAR      OBSERVER            "
